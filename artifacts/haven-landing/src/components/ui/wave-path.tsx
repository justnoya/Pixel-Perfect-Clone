  ...
  return (
    <div className={cn("relative h-px w-full", className)} {...props}>
      <div
        ...
        className="relative -top-5 z-10 h-10 w-full hover:-top-[60px] hover:h-[120px] transition-all duration-0"
      />
      <svg className="absolute -top-[60px] h-[120px] w-full overflow-visible pointer-events-none">
        <path
          ref={path}
          className="fill-none"
