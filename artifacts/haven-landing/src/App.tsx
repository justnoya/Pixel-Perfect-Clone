          ...
          >
            ...
            <div
              style={{
                ...
                height: 320,
                borderRadius: "50%",
                background: "radial-gradient(circle, rgba(120,80,255,0.09) 0%, transparent 70%)",
                pointerEvents: "none",
              }}
            />
            {/* Subtle radial glow in bottom-left */}
            <div
              style={{
                position: "absolute",
                bottom: "-80px",
                ...
                height: 280,
                borderRadius: "50%",
                background: "radial-gradient(circle, rgba(255,120,60,0.07) 0%, transparent 70%)",
                pointerEvents: "none",
              }}
            />

            {/* Top row — what you get */}
            <div style={{ display: "flex", gap: "clamp(12px, 3vw, 32px)", width: "100%", justifyContent: "center", flexWrap: "wrap", position: "relative", zIndex: 1 }}>
              {[
                { icon: "📈", n: "20–30", sub: "Qualified leads / month" },
                { icon: "⚡", n: "7 days", sub: "System goes live" },
                { icon: "🔒", n: "100%", sub: "Fee back if we miss" },
              ].map((s) => (
                <div
                  key={s.n}
                  style={{
                    ...
                    border: "1px solid rgba(255,255,255,0.07)",
                    borderRadius: 14,
                    padding: "clamp(12px, 2vh, 20px) clamp(10px, 2vw, 20px)",
                    textAlign: "center",
                  }}
                >
                  <div style={{ fontSize: "clamp(18px, 2vw, 24px)", marginBottom: 6 }}>{s.icon}</div>
                  <div style={{ fontFamily: COURIER, fontSize: "clamp(20px, 2.2vw, 30px)", color: "white", fontWeight: 400, lineHeight: 1, marginBottom: 4 }}>
                    {s.n}
                  </div>
                  <div style={{ fontFamily: SANS, fontSize: "clamp(9px, 0.7vw, 11px)", color: "rgba(255,255,255,0.35)", textTransform: "uppercase" as const, letterSpacing: "0.1em", lineHeight: 1.4 }}>
                    {s.sub}
                  </div>
                </div>
              ))}
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 14, width: "100%", position: "relative", zIndex: 1 }}>
              <div style={{ flex: 1, height: 1, background: "rgba(255,255,255,0.06)" }} />
              <span style={{ fontFamily: SANS, fontSize: 10, color: "rgba(255,255,255,0.2)", letterSpacing: "0.16em", textTransform: "uppercase" as const, whiteSpace: "nowrap" as const }}>
                how it starts
              </span>
              <div style={{ flex: 1, height: 1, background: "rgba(255,255,255,0.06)" }} />
            </div>
            ...
            <div style={{ display: "flex", gap: "clamp(8px, 2vw, 24px)", width: "100%", justifyContent: "center", flexWrap: "wrap", position: "relative", zIndex: 1 }}>
              {[
                { step: "01", label: "30-min free call", desc: "No pitch. Just your numbers." },
                { step: "02", label: "Custom plan", desc: "Tailored to your project & city." },
                { step: "03", label: "Go live in 7 days", desc: "Leads in the first week." },
              ].map((t, i) => (
                <div key={t.step} style={{ display: "flex", alignItems: "flex-start", gap: 10, flex: "1 1 140px", maxWidth: 200 }}>
                  <div
                    style={{
                      width: 28,
                      height: 28,
                  ...
                  <div>
                    <div style={{ fontFamily: SANS, fontSize: "clamp(11px, 0.9vw, 13px)", color: "rgba(255,255,255,0.85)", fontWeight: 500, marginBottom: 2 }}>
                      {t.label}
                    </div>
                    <div style={{ fontFamily: SANS, fontSize: "clamp(9px, 0.7vw, 11px)", color: "rgba(255,255,255,0.3)", lineHeight: 1.5 }}>
                      {t.desc}
                    </div>
                  </div>
                </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 14, position: "relative", zIndex: 1 }}>
              ...
              <p style={{ fontFamily: SANS, fontSize: 10, color: "rgba(255,255,255,0.18)", margin: 0, letterSpacing: "0.08em" }}>
